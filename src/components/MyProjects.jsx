                ...
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    >
                      ...
                      practitioner through a video chat. Also offers other
                      services such appointment booking.
                    </Typography>
                  </CardContent>
                </CardActionArea>
                <CardActions>
                ...
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography
                      ...
                      color="rgba(255, 255, 255, 0.7)"
                    >
                      A React based app that allows the user to book an
                      appointment by selecting a day, picking an open spot and
                      selecting an available interviewer
                    </Typography>
                  </CardContent>
                </CardActionArea>
                <CardActions>
                ...
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography
                      ...
                      color="rgba(255, 255, 255, 0.7)"
                    >
                      A React app where a user can receive weather information
                      from any location in the world that they choose.
                    </Typography>
                  </CardContent>
                </CardActionArea>
                <CardActions>
                ...
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography
                      ...
                      color="rgba(255, 255, 255, 0.7)"
                    >
                      Full stack CRUD app built with Node and Express that
